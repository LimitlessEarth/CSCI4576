...
dnl
dnl Generated by mpiteam at Tue Jul 12 16:17:24 2016
...
m4_define([mca_opal_common_m4_config_component_list], [libfabric, verbs_usnic, ugni, sm, verbs, cuda])
...
m4_define([mca_opal_btl_m4_config_component_list], [smcuda, ugni, sm, scif, portals4, tcp, openib, vader, usnic])
...
m4_define([mca_opal_mpool_m4_config_component_list], [udreg, rgpusm, gpusm])
...
m4_define([mca_opal_pmix_m4_config_component_list], [s1, cray, s2, pmix112, external])
...
m4_define([mca_opal_timer_m4_config_component_list], [solaris, altix, linux, darwin])
...
m4_define([mca_orte_ess_no_config_component_list], [pmi, tool, hnp, singleton, env])
...
m4_define([mca_orte_oob_m4_config_component_list], [alps, usock, tcp, ud])
...
m4_define([mca_orte_rmaps_no_config_component_list], [resilient, seq, round_robin, mindist, ppr, staged, rank_file])
...
m4_define([mca_ompi_coll_m4_config_component_list], [hcoll, fca, portals4, cuda])
...
m4_define([mca_ompi_fbtl_m4_config_component_list], [pvfs2, posix, plfs])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [individual, dynamic, static, two_phase])

dnl Components in the ompi / fs framework
m4_define([mca_ompi_fs_m4_config_component_list], [pvfs2, lustre, plfs])
...
m4_define([mca_ompi_osc_m4_config_component_list], [pt2pt, rdma, portals4])
m4_define([mca_ompi_osc_no_config_component_list], [sm])

dnl Components in the ompi / pml framework
m4_define([mca_ompi_pml_m4_config_component_list], [v, yalla, ob1, ucx])
